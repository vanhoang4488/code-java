...
@WebServlet(urlPatterns = { "/ad/insertSpending" })
public class InsertSpending extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
       try {   
           ...
           if(check) {
        	   ...
        	   RequestDispatcher dispatcher = this.getServletContext().getRequestDispatcher("/ad/quanlychi");
