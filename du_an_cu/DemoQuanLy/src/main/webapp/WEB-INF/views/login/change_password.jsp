...
/*end reset*/
body {
    background: url(https://p.w3layouts.com/demos_new/template_demo/28-07-2017/online_login_form-demo_Free/1930595034/web/images/1.jpg)no-repeat center top;
	...
	<div class="main-content-agile">
		<div class="sub-main-w3">	
			<div class="wthree-pro">
				<h2>Nhập mã số nhân viên để lấy lại mật khẩu</h2>
			</div>
			<form method="post" action="${pageContext.request.contextPath}/forget">
				<div class="pom-agile" style="margin-bottom:10px;">
					<input type="text" id="userName" name="userName" value="" maxlength="8" required disabled/>
				</div>
