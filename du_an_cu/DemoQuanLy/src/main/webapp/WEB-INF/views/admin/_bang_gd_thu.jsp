...
<div>
   <form id="formchooseday" method = "POST" action="${pageContext.request.contextPath}/ad/quanlythu" >
        ...
        <input style="margin:20px; ;border: 1px solid #07c25f;color:#07c25f;margin-left: 20px;margin-right: 20px;width: 175px;" type="date" id="chooseday1" name="chooseday1" value="${date1}" onchange="check()"/>
        
        <input style="margin:20px;border: 1px solid #07c25f;color:#07c25f;margin-left: 20px;margin-right: 20px;width: 175px;" type="date" id="chooseday2" name="chooseday2" value="${date2}" onchange="check()"/> 
    	   ...
    	   <fieldset style="border: 1px solid #07c25f">
			...
			<div class="lable">  
			 ...
			 <div class="lable">   
    	        ...
    	        <input style="float: right;border: 1px solid #07c25f;color:#07c25f;margin-left: 40px;margin-right: 20px;padding: 4px;" type="text" name="revenues"  id="revenues" value="" maxlength="30" required/> <br />
			 </div>
			 <div class="lable">     
