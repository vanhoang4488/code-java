/*
  Đề bài được lưu trong folder của Java_Visitor_Pattern.
*/
...
public class Java_Visitor_Pattern {
    ...
    public static Tree solve() {
        ...
        for (int i = 0; i < numNodes - 1; i++) {
            ...
            /*
            * Ở đây ta phải tiến hành liên kết thêm theo chiều ngươc lại vì đề bài
            * chỉ cho nhập u và v để thể hiện hai nút này có liên kết cạnh với nhau thôi
            * chứ không nói rằng u là cha của v.
            */
    ...
    /* Recursively adds children of a TreeNode */ /* Ở đây ta đã tiến hành duyệt sâu.*/
    private static void addChildren(TreeNode parent, Integer parentNum) {
        ...
        for (Integer treeNum : map.get(parentNum)) {
            ...
            /*
            * Xóa liên kết theo chiều ngược lại để tránh duyệt trùng lặp dẫn đến sai kết quả.
            */
            /* Add child */
